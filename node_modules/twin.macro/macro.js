...
var getStyles = (function (classes, t, state) {
  ...
  var styles = classesOrdered.reduce(function (results, classNameRaw) {
    ...
    var hasNoMatches = ref.hasNoMatches;
    ...
    assert(hasNoMatches && !hasUserPlugins, function () { return errorSuggestions({
      pieces: pieces,
      state: state
    }); });
    var styleHandler = {
    ...
    assert(hasNoMatches && !style, function () { return errorSuggestions({
      pieces: pieces,
      state: state
    }); });
...
var twinMacro = function (ref) {
  ...
  state.isDev = isDev;
  state.isProd = !isDev; // Styled import
